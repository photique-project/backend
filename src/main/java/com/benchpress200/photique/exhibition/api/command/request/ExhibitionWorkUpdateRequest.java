...
@Setter
@NoArgsConstructor
public class ExhibitionWorkUpdateRequest {
    private static final String INVALID_WORK_ID = "Invalid work id";
    ...
    @NotNull(message = INVALID_WORK_ID)
    private Long id;
    ...
    @NotNull(message = INVALID_WORK_TITLE)
    @Size(min = 1, max = 30, message = INVALID_WORK_TITLE)
    private String title;

    @NotNull(message = INVALID_WORK_DESCRIPTION)
