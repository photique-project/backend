...
@Getter
@Builder
public class BookmarkedExhibitionSearchResponse {
    private int page;
    private int size;
    ...
    public static BookmarkedExhibitionSearchResponse from(BookmarkedExhibitionSearchResult result) {
        return BookmarkedExhibitionSearchResponse.builder()
                .page(result.getPage())
                .size(result.getSize())
